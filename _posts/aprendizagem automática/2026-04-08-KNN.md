---
title: KNN
excerpt: "KNN é um algoritmo baseado em vizinhança que funciona em espaços métricos, classificando ou prevendo valores a partir dos K pontos mais próximos segundo uma função de distância (Euclidiana, Manhattan, Jaccard, etc.). Não possui fase de treino, sendo simples de usar, porém mais lento em datasets grandes."
---
